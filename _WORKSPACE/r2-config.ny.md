# R2 – New York Router Configuration
...
### G0/0/1 — WAN Link to R1

```
interface g0/0/1
ip address 10.101.2.226 255.255.255.252
no shutdown
```

| | Value |
|---|---|
| **IP Address** | 10.101.2.226 |
| **Subnet Mask** | 255.255.255.252 (/30) |
| **Purpose** | Point-to-point WAN link toward R1 |

> R1's side of this link is `10.101.2.225` — these two IPs form the /30 WAN subnet.
...
ip address 10.101.2.125 255.255.255.192
```

| | Value |
|---|---|
| **VLAN** | 100 |
| **Gateway IP** | 10.101.2.125 |
...
ip address 10.101.2.61 255.255.255.192
```

| | Value |
|---|---|
| **VLAN** | 200 |
| **Gateway IP** | 10.101.2.61 |
...
```
! Routes to R1 networks
ip route 10.101.0.0 255.255.255.0 10.101.2.225
ip route 10.101.1.0 255.255.255.0 10.101.2.225

! Default route
ip route 0.0.0.0 0.0.0.0 10.101.2.225
```

| Destination | Mask | Next Hop | Purpose |
|---|---|---|---|
| 10.101.0.0 | /24 | 10.101.2.225 | Route to R1 network 1 |
| 10.101.1.0 | /24 | 10.101.2.225 | Route to R1 network 2 |
| 0.0.0.0 | /0 | 10.101.2.225 | Default route (internet / unknown traffic) |

- The next hop `10.101.2.225` is R1's IP on the WAN link.

---

## R1 ↔ R2 WAN Link Summary

| Router | Interface | IP Address | 
|---|---|---|
| R1 | G0/0/1 | 10.101.2.225 /30 |
| R2 | G0/0/1 | 10.101.2.226 /30 |
