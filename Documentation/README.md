...
#### Final Report — CSN Network Project [(docs)](docs)
...
#### UAT Test Plan — CSN Network Project [(docs)](docs)
...
Each device has its own configuration file. Follow the steps below to apply a config in Cisco Packet Tracer.
...
3. Open the corresponding configuration file from the tables below.
